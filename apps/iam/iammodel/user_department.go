...
type UserDeptType string

const (
	UserDeptTypePrimary   UserDeptType = "primary"
	UserDeptTypeSecondary UserDeptType = "secondary"
)
...
type UserDepartmentEntity struct {
	...
	DeptType  UserDeptType `gorm:"column:dept_type;type:varchar(16);;default primary;comment: 部门类型: primary-主部门 secondary-其他部门"`
